 ...
 * @author norha
 */
public class jNewItem extends javax.swing.JFrame {

    /**
     * Creates new form jNewItem
     */
    public jNewItem() {
        initComponents();
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(jNewItem.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
